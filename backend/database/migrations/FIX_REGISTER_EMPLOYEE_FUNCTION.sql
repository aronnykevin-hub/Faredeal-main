-- =========================================
-- EMPLOYEE REGISTRATION RPC FUNCTION
-- Handles traditional signup for employees
-- =========================================
...
DROP FUNCTION IF EXISTS public.register_employee(
  p_username TEXT,
  p_password TEXT,
  p_full_name TEXT,
  p_phone TEXT,
...
GRANT EXECUTE ON FUNCTION public.register_employee(

-- =========================================
-- EMPLOYEE PROFILE UPDATE RPC FUNCTION
...
DROP FUNCTION IF EXISTS public.update_employee_profile_on_submission(
  p_auth_id UUID,
  p_full_name TEXT,
  p_phone TEXT,
  p_position TEXT
...
-- Create the function to update employee profile on submission
CREATE OR REPLACE FUNCTION public.update_employee_profile_on_submission(
  p_auth_id UUID,
  p_full_name TEXT,
  p_phone TEXT,
  p_position TEXT,
...
GRANT EXECUTE ON FUNCTION public.update_employee_profile_on_submission(
